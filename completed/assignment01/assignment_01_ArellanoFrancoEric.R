...
week1_sleep > 8
## answer determines which days but not how many. My initial thought was sum(isTRUE(week1_sleep>8)) but isTRUE operator returns single value
## sum(week1_sleep > 8) does the job since TRUE = 1 and 
